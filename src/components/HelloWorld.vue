      ...
      <mdc-layout-grid>
        <mdc-layout-cell desktop="12" tablet="8" phone="4">
          ...
          <p class="hello__blurb">
            <a
              href="https://github.com/webdenim/vue-cli-plugin-material"
              target="_blank"
              rel="noopener"
            >vue-cli-plugin-material</a> is a Vue CLI plugin to help you get started with Material Design Components for Vue.js. It's created and maintained by
            <a
              href="https://twitter.com/rustemgareev"
              target="_blank"
              rel="noopener"
            >Rustem Gareev</a> at
            <a href="https://www.webdenim.io/" target="_blank" rel="noopener">Webdenim</a>.
            <a
              href="https://github.com/rustemgareev"
              target="_blank"
              rel="noopener"
            >Follow me on GitHub</a> to get news and updates on other Vue.js and Material Design-related stuff.
          </p>
        </mdc-layout-cell>
      </mdc-layout-grid>
    </div>
